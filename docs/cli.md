...
The public product CLI does not expose a `relinkra register` command. For CBM workspace registration, use `relinkra cbm index`; this is the supported route in the current release.
